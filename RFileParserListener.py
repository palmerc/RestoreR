...
class RFileParserListener(ParseTreeListener):
    ...
    def enterClassDeclaration(self, ctx:JavaParser.ClassDeclarationContext):
        self.r_variables.append(ctx.IDENTIFIER().getText())
    ...
    def enterVariableDeclarator(self, ctx:JavaParser.VariableDeclaratorContext):
        self.r_variables.append(ctx.variableDeclaratorId().getText())
        self.r_variables.append(ctx.variableInitializer().getText())
    ...
    def exitVariableDeclarator(self, ctx:JavaParser.VariableDeclaratorContext):
        value = self.r_variables.pop()

        self.r_mapping[int(value)] = ".".join(self.r_variables)
